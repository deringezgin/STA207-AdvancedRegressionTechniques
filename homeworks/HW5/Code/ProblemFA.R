...
plot(x=X,
     y=Y,
     xlab="Log of Lower Status of the Population (percent)",
     ylab="Log of Median Value of Owner-Occupied Homes (in $1000s)",
     pch=PCH,
     cex=CEX,
     main="Scatterplot of Log of Population Percentage [X] vs. Log of Median Home Prices [Y] (Plot-A)")

# Scatterplot of Fitted Values vs Real Values
plot(x=Y,
     y=fit$fitted.values,
     xlab="Log of Median Value of Owner-Occupied Homes (in $1000s)",
     ylab="Fitted Values",
     pch=PCH,
     cex=CEX,
     main="Scatterplot of Log of Real Median Home Price [X] vs. Fitted Median Home Price [Y] (Plot-B)")
